            ...
            <div className="col-xl-6 py-4 ">
              <div className={styles.footer_image}>
                ...
                <div>
                  ...
                  <h2 className="text  "> 
                  <a href="tel:8103490175" className="text-reset text-decoration-none">8103490175</a></h2>
                </div>
              </div>
            </div>
            <div className="col-xl-6 py-4 ">
              ...
              <div className={styles.footer_maindiv}>
                <Slide right>
                  <div>
                    <a href="https://github.com/RupeshSahu969">
                      <svg
                  ...
                  <div>
                    <a href="https://www.linkedin.com/in/rupesh-sahu-4924a6119/">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="46"
                        height="46"
                  ...
                  <div>
                    <a href="mailto:rupeshshau969@email.com?subject=subject&cc=rupeshshau1811@example.com">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="46"
                        height="46"
